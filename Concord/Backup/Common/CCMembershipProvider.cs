...
namespace Common
{
    public class CCMembershipProvider : MembershipProvider
    {
        ...
        */
        ...
        //private string eventSource = "CCMembershipProvider";
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            if (name == null || name.Length == 0)
                name = "CCMembershipProvider";

            if (String.IsNullOrEmpty(config["description"]))
            {
                config.Remove("description");
                config.Add("description", "CDN Membership provider");
            }
        ...
        {
            throw new ProviderException("Unimplemented");
            ...
            cmd.Parameters.Add("@Password", OdbcType.VarChar, 255).Value = EncodePassword(newPassword);
                      ...
                      string newPasswordAnswer)
        {
            ...
            cmd.Parameters.Add("@Answer", OdbcType.VarChar, 255).Value = EncodePassword(newPasswordAnswer);
            cmd.Parameters.Add("@Username", OdbcType.VarChar, 255).Value = username;
            cmd.Parameters.Add("@ApplicationName", OdbcType.VarChar, 255).Value = pApplicationName;
                 ...
                 out MembershipCreateStatus status)
        {
            ...
            if (u == null)
            {
                ...
                {
                    Globals.Log("CreateUser:"+Environment.NewLine+e.ToString());
        ...
        public override MembershipUser GetUser(string username, bool userIsOnline)
        {
            ...
            MembershipUser u = new MembershipUser(
                ...
                true, //isApproved,
                false, //isLockedOut,
                new DateTime(2000, 1, 1), //creationDate,
                new DateTime(2000, 1, 1), //lastLoginDate,
                new DateTime(2000, 1, 1), //lastActivityDate,
                new DateTime(2000, 1, 1), //lastPasswordChangedDate,
                new DateTime(2000, 1, 1) //lastLockedOutDate
            );
            return u;
        ...
        /*
        private static MembershipUser GetUserFromReader(OdbcDataReader reader)
        {
            throw new ProviderException("Unimplemented");
        ...
        */
        ...
        {
            throw new ProviderException("UnlockUser Unimplemented. userName=" + userName);
        ...
        /*
            ...
            private static void UpdateFailureCount(string username, string failureType)
            {
                OdbcConnection conn = new OdbcConnection(connectionString);
        ...
        */
        ...
        {
            throw new ProviderException("ValidateUser Unimplemented");
            /*
            OdbcConnection conn = new OdbcConnection(connectionString);
            OdbcCommand cmd = new OdbcCommand("SELECT Count(*) FROM Users " +
