...
namespace ScratchConsole
{
    class Program
    {
        ...
        private static void DisplayFile(DataSet ds)
        {
        ...
        private static DataSet ReadFile(string sQuery)
        {
            ...
            OleDbConnection con = new OleDbConnection(
                "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\\bootdrv\\aloha\\20100326;Extended Properties=dBASE IV;User ID=;Password=;");
            try
            {
