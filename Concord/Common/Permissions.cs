...
namespace Common
{
    public static class Permissions
    {
        ...
        public static int TipshareLevel
        {
            get
            {
                string temp = System.Configuration.ConfigurationManager.AppSettings["TipsharePermissionLevel"];
        ...
        public static int ProjectsLevel
        {
            get
            {
                string temp = System.Configuration.ConfigurationManager.AppSettings["ProjectsPermissionLevel"];
                if (!string.IsNullOrEmpty(temp))
        ...
        public static int IssuesLevel
        {
            get
            {
                string temp = System.Configuration.ConfigurationManager.AppSettings["IssuesPermissionLevel"];
                if (!string.IsNullOrEmpty(temp))
        ...
        public static int UsersLevel
        {
            get
            {
                string temp = System.Configuration.ConfigurationManager.AppSettings["UsersPermissionLevel"];
                if (!string.IsNullOrEmpty(temp))
